            ...
            steps{
        		...
        		script{
        		   ...
        		   env.TARGET = 'https://zero.webappsecurity.com/'
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:172.18.0.1" -v mnt/c/Users/claud/Documents/DevSecOps/Practica/jenkins_home/tools:/zap/wrk/ -t owasp/zap2docker-stable zap-full-scan.py \ -t https://zero.webappsecurity.com /-g gen.conf -r testreport.html --hook=/zap/wrk/my-hooks.py'
