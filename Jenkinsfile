            ...
            steps{
        		...
        		script{
        	       ...
        	       // sh '${DOCKER_EXEC} rm -f zap2'
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:172.17.0.1" -v /Users/claud/Documents/Jenkins/jenkins_home/tools:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-full-scan.py -t "https://zero.webappsecurity.com/" -I -r zap_full_report.html -l PASS'
